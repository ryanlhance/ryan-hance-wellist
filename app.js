...
(function () {
  ...
  function showLoadError(err) {
    ...
    el.loadError.innerHTML =
      ...
      "Serve the folder over http instead — e.g. run <code>python3 serve.py</code> " +
      "in this folder and open <code>http://localhost:8766/</code>, or view it on GitHub Pages.<br><br>" +
